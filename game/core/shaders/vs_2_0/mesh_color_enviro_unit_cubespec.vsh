// (C)2008 S2 Games
// mesh_color_enviro_unit_cubespec.vsh
// 
// ...
//=============================================================================
...
VS_OUTPUT VS( VS_INPUT In )
{
    ...
    Out.Reflect.xyz    = reflect(vPositionOffset, vWVNormal);
    
    float fFresnelBias = -1.5f;
    float fFresnelScale = 4.0f;
    float fFresnelPower = 1.2f;
    Out.Reflect.w = saturate(fFresnelBias + fFresnelScale * pow(1.0f + dot(normalize(vPositionOffset), normalize(vWVNormal)), fFresnelPower));
