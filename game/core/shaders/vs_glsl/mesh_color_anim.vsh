...
uniform float   fSpeedX;
uniform float   fSpeedY;
...
void main()
{
    ...
    gl_TexCoord[0]   = vec4(gl_MultiTexCoord0.xy + vec2(fSpeedX * fTime, fSpeedY * fTime), 0.0, 0.0);
    ...
    v_vSunLight.xyz  = mRotate * vLight;
