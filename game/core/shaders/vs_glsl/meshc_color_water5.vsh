...
void main()
{
    ...
    v_vColor.a *= v_vColor.a;
    gl_TexCoord[0].xy = gl_MultiTexCoord0.xy + vec2(fSpeed * fTime, fSpeed * fTime);
    gl_TexCoord[0].zw = gl_MultiTexCoord0.xy * -1.5 + vec2(fSpeed * fTime, fSpeed * fTime);
